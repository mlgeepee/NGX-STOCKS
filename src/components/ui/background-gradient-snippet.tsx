export default function Component() {
  return (
    <div className="fixed inset-0 -z-10 bg-white dark:bg-neutral-200">
      <div className="absolute inset-0 bg-[radial-gradient(circle_560px_at_50%_200px,#A8D8B9,transparent)]" />
