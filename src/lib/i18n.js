const TRANSLATIONS = {
    en: {
        ...
        phase2: {
            simulator: {
                sectionKicker: "Simulator",
                title: "Next-day projection",
                description: "Heuristic projection using the current market snapshot.",
                initialCapitalLabel: "Initial capital",
                symbolsLabel: "A / B symbols",
                symbolAPlaceholder: "A",
                symbolBPlaceholder: "B",
                weightALabel: "Weight A (%)",
                weightBLabel: "Weight B (%)",
                projectedReturnLabel: "Projected next-day return",
                projectedCapitalLabel: "Projected capital",
                emptyHint: "Enter valid A and B symbols to see the projection.",
                noContributions: "No contributions found. Check symbol match and weights.",
                contributionBreakdown: "Contribution breakdown",
                contributionWeight: "Weight: {value}%",
                expectedMoveLabel: "Exp move",
                contributionLabel: "Contrib",
                disclaimer: "Based on the current board snapshot only; not investment advice.",
            },
            whaleDetector: {
                sectionKicker: "Whale detector",
                title: "Volume spike watch",
                description: "Symbols trading with unusually high volume versus average.",
                noCandidates: "No whale candidates right now.",
                volumeMultiplierLabel: "vol multiplier",
            },
            stockCompare: {
                sectionKicker: "Compare",
                title: "Stock compare",
                description: "Side-by-side fields from the current board snapshot.",
                aSymbolLabel: "A symbol",
                bSymbolLabel: "B symbol",
                placeholderA: "e.g. DANGCEM",
                placeholderB: "e.g. GTCOPLC",
                hint: "Enter two valid symbols to compare.",
                priceLabel: "Price",
                movePercentLabel: "Move %",
                deltaLabel: "Delta %",
            },
            riskMeter: {
                sectionKicker: "Risk meter",
                title: "Market risk score",
                description: "Heuristic score based on volatility and movement.",
                riskLabel: "Risk",
                riskStatus: {
                    low: "Low risk",
                    medium: "Medium risk",
                ...
                volatilityComponentLabel: "Volatility component",
                movementComponentLabel: "Movement component",
            },
        },
    },
    pid: {
        ...
        phase2: {
            simulator: {
                sectionKicker: "Simulator",
                title: "Next-day projection",
                description: "Na current market snapshot we dey use for this projection.",
                initialCapitalLabel: "Initial capital",
                symbolsLabel: "A / B symbols",
                symbolAPlaceholder: "A",
                symbolBPlaceholder: "B",
                ...
                projectedReturnLabel: "Projected next-day return",
                projectedCapitalLabel: "Projected capital",
                emptyHint: "Put correct A and B symbols make you see projection.",
                noContributions: "No contribution show. Check the symbol and weight.",
                contributionBreakdown: "How each contribution take add up",
                contributionWeight: "Weight: {value}%",
                expectedMoveLabel: "Expected move",
                contributionLabel: "Contrib",
                disclaimer: "Na current board snapshot only. No be investment advice.",
            },
            whaleDetector: {
                sectionKicker: "Whale detector",
                title: "Volume spike watch",
                description: "Symbols wey volume don spike pass normal.",
                noCandidates: "No whale candidate now.",
                volumeMultiplierLabel: "vol multiplier",
            },
            stockCompare: {
                sectionKicker: "Compare",
                title: "Stock compare",
                description: "See both symbols side by side from current board.",
                aSymbolLabel: "A symbol",
                bSymbolLabel: "B symbol",
                placeholderA: "e.g. DANGCEM",
                placeholderB: "e.g. GTCOPLC",
                hint: "Put two valid symbols make you compare.",
                priceLabel: "Price",
                movePercentLabel: "Move %",
                deltaLabel: "Delta %",
            },
            riskMeter: {
                sectionKicker: "Risk meter",
                title: "Market risk score",
                description: "Score wey based on volatility and movement.",
                riskLabel: "Risk",
                riskStatus: {
                    low: "Low risk",
                    medium: "Medium risk",
